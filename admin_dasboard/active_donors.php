      ...
      while($row = $members->fetch_array()) {
       ?>
        ...
        <td><?php echo $row['blood_units_reqd'];?></td>
                ...
                <td><button type="button" data-toggle="modal" data-target="#deletdonor<?php echo $row['donor_id']?>" class="btn btn-danger">Delete</button></td>
</tr>
 <!-- delete city modal -->
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form action="add_donor.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <input type="text" class="form-control" name="datepicker" id="datepicker" placeholder="Enter dob(yyyy-mm-dd)"></input>
          </div>
<div class="form-group">
