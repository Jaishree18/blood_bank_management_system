      ...
      <div class="container-fluid">
        ...
        <div id="navbar-menu">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="../assets/img/user.png" class="img-circle" alt="Avatar" onclick = "myFunction" > <span><?php echo $_SESSION['username'];?></span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
...
<div class="panel panel-headline">
                                                ...
                                                <div class="panel-body">
                                                        <div class="row">
                                                                ...
                                                                <div class="panel-body">
                                                                        <table class="table table-hover" id="list-requester">
                                                                                <thead>
                                                                                        <tr>
                                                                                                <th>Requester id</th>
                                                                                                <th>Name</th>
