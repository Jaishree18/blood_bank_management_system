                                        ...
                                        <div class="left">
                                                <div class="content">
                                                        <div class="header" style="margin-bottom:0px;">
                                                                <div class="logo text-center">SAVIOUR</div>
...
<div class="form-group">
                                                                        <label for="signin-phone" class="control-label sr-only">Phone</label>
                                                                        <input type="text" class="form-control" name="phone" id="phone" placeholder="Phone number" required="">
                                                                </div>

<div class="form-group">
                                                                        <label for="signin-address" class="control-label sr-only">Address</label>
...
<div class="form-group">
                                        ...
                                        <div class="right">
                                                ...
                                                <div class="content text">
                                                        <h1 class="heading">Welcome To the Blood Bank System</h1>
                                                        <p>Vanshika Bhavnani D17B-03</p>
<p>Gunjan Bhawsinghka D17B-04</p>
